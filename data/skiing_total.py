...
with open('data/JPN_skiing_total.csv') as csvfile: 
	reader = csv.reader(csvfile)
	line_count = 0

	for row in reader:
		if line_count is 0:
			print("This is Japanese Skiing Togal Medals")
...
plt.title("Olympic Medals of Japanese Skiing - Historic Medal Counts")
