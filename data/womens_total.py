...
with open('data/JPN_womens_total.csv') as csvfile: 
	reader = csv.reader(csvfile)
	line_count = 0

	for row in reader:
		if line_count is 0:
			print("This is Then Number of Japanese Total Medals(Women)")
...
plt.title("Then Number of Japanese Olympic Medals(Women)")
