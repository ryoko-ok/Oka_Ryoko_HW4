...
with open('data/JPN_skating_total.csv') as csvfile: 
	reader = csv.reader(csvfile)
	line_count = 0

	for row in reader:
		if line_count is 0:
			print("This is Japanese Skating Total Medals")
...
plt.title("Olympic Medals of Japanese Skating - Historic Medal Counts")
plt.xlabel("Medal Counts Since 1956")
plt.show()
